...
class GroupExtrapolation(Group):
    def __init__(self, agg_list_initializer: list[AggregateInitializer], cache_size, extrapolation_method='linear'):
    ...
    def _update_cache(self):
        ...
        self._aggregate_cache_timestamps.append(datetime.now())
    ...
    def extrapolate(self):
        ...
        extrapolation_timestamp = datetime.now()
