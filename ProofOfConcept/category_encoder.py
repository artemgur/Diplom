...
class CategoryEncoder:
    ...
    def fit(self, data: pd.DataFrame):
        categorical_columns = pdu.get_categorical_columns(data)
        numerical_columns = pdu.get_numerical_columns(data)
        ...
        for categorical_column in categorical_columns:
            ...
            self._best_correlations[categorical_column] = best_p_value_column if best_p_value < self._p_value_threshold else None
            self._best_correlations_means[categorical_column] = best_mean if best_p_value < self._p_value_threshold else None
